...
$db = new PDO('mysql:host='.$call->hostname.';dbname='.$call->database,$call->username, $call->password);
$db->setAttribute( PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION );

if(!empty($_SESSION['user'])){
$user = $db->query("SELECT * FROM db_users WHERE username='".($_SESSION['user'])."' ");
if($user->rowCount() == 0){
