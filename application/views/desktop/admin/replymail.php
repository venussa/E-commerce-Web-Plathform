...
<p style="background: #f5f5f5;padding: 10px;border:1px #ddd solid;border-radius: 5px;">Subject : <?php echo $show['subject']?></p>
...
<div class="big-panel-box" style="margin-top:20px;border:transparent;">
	...
	<tr>
		<td style="border: transparent;background: #f5f5f5">

			<form method="POST" action="<?php echo HomeUrl()?>/adminpanel/reply_mail?id=<?php echo $this->get('id')?>" enctype="multipart/form-data">
	
				<textarea style="width: 97%" type="text" name="reply" class="form-input"></textarea>
