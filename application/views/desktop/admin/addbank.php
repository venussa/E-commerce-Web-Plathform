...
<table width="100%" style="">
	...
	<tr>
		...
		<td><input type="text" name="bank_info" class="form-input" required></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="code_bank" class="form-input" required></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="atas_nama" class="form-input" required></td>
	</tr>
