...
<table width="100%" style="">
	<tr>
		...
		<td><input type="text" name="title" class="form-input" required onKeyup="return create_slug(this)"></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" id="slugs" name="slug" class="form-input" required>
