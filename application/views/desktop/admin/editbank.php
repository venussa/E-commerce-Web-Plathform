...
<table width="100%" style="">
	<tr>
		...
		<td><input type="text" name="bank_name" class="form-input" required value="<?php echo $show['bank_name']?>"></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="bank_info" class="form-input" required value="<?php echo $show['bank_info']?>"></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="code_bank" class="form-input" required value="<?php echo $show['code_bank']?>"></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="atas_nama" class="form-input" required value="<?php echo $show['atas_nama']?>"></td>
	</tr>
