...
<head>
	...
	<link rel="stylesheet" href="<?php echo HomeUrl() ?>/css/admin.css" />
...
<body>
	...
	<div style="background: #fff;float:left;width: 100%;padding: 10px;margin-left: -13px;margin-top: 100px;border-top:1px #ddd solid;">
		<p class="container">&copy;<?php echo date("Y")?>. All Rights Reserverd.</p></div>
