...
<form method="get" action="<?php echo HomeUrl()?>/adminpanel/customer_funds" style="float:right">
			...
			while($show = $query->fetch()){ 
				...
				<tr>
					<td colspan="2"><img src="<?php echo $pict?>" style="width:50px;height:50px;border-radius: 100%;position: absolute;margin-top:10px;">
						<p style="font-family: Segoe UI Bold;margin-left:70px;"><?php echo ucwords($show['first_name']." ".$show['last_name']) ?></p>
					...
					<td style="width: 150px;"><p style="font-family: Segoe UI Bold">Rp <?php echo number_format($saldo)?></p></td>
