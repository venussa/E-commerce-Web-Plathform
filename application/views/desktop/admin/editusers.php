...
<table width="100%" style="">
	<tr>
		...
		<td><input type="text" name="first_name" class="form-input" required value="<?php echo $show['first_name']?>" style="<?php echo $style?>" <?php echo $editable?>></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="last_name" class="form-input" value="<?php echo $show['last_name']?>" style="<?php echo $style?>" <?php echo $editable?>></td>
	</tr>
	...
	<tr>
		...
		<td><textarea type="text" name="address" class="form-input" rows="2" style="max-width: 96.1%;min-width: 96%;font-size: 13px;<?php echo $style?>" required <?php echo $editable?>><?php echo $show['address']?></textarea></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="zip_code" class="form-input" required value="<?php echo $show['zip_code']?>" readonly="" style="background: #f5f5f5"></td>
	</tr>
	...
	<tr>
		...
		<td><input type="email" style="background: #f5f5f5" readonly=""  class="form-input" required value="<?php echo $show['email']?>" <?php echo $editable?>></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" style="background: #f5f5f5" readonly="" class="form-input" required value="<?php echo $show['phone_number']?>" <?php echo $editable?>></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" style="background: #f5f5f5" readonly=""  class="form-input" required value="<?php echo $show['username']?>" <?php echo $editable?>></td>
	</tr>
	...
	<tr>
		...
		<td id="child-category-select">
			...
			<select type="text" name="level" onChange="return role_access(this)" class="form-input" style="width: 99.5%" required <?php echo $editable?>>
