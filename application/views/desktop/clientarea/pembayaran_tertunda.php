		...
		<table width="100%">
			...
			<tr>
				...
				<td valign="top" style="width: 120px;">
					...
					<p style="font-family: 'Segoe UI Regular';font-size: 13px;border:1px #ddd solid;border-radius: 5px;width: 70px;text-align: center;">
						<img src="<?php echo sourceUrl()?>/media/wallet.png" style="width:40px;height:40px;">
					</p>
					<p style="color:green;font-style: italic;font-family: 'Segoe UI Bold';">Telah Diverifikasi</p>
					<?php }else{ ?>
					...
					<p style="font-family: 'Segoe UI Regular';font-size: 13px;margin-top: 35px;">
						<a href="<?php echo HomeUrl()?>/clientarea/konfirmasi_pembayaran?id=<?php echo $show['sorting_id']?>"><button class="btn-white" style="width: 100px;border-radius: 5px;">Konfirmasi</button></a>
