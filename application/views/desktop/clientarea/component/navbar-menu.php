<div class="navbar">
		<div class="container">
			<div class="left-content"><a href="<?php echo HomeUrl()?>"><img src="<?php echo setting()->logo?>" style="height:30px;"></a></div>
			<div class="right-content" style="width: 600px;">
				...
				<a href="<?php echo HomeUrl()?>/clientarea/pengaturan_profile" style="color:#434343">
				...
				<a href="<?php echo HomeUrl()?>/clientarea/informasi_pengguna" style="color:#434343">
					<p class="nav-menu-right" style="margin-right: 45px;">
