...
<div class="big-panel-box" style="margin-top:20px;width: 49%;float: left;">

	<?php if(($product['transaction_scheme'] < 1) or (($order_pending > 0) and ($product['transaction_scheme'] > 0))){ ?>

	<p style="text-align: center;font-size:20px;">Segera lakukan pembayaran sebelum</p>

	<?php }else{ ?>

	<p style="text-align: center;font-size:20px;">Sisa waktu tunggu</p>	

	<?php } ?>

	<div style="width: 250px;background: #f5f5f5;border-radius: 5px;border:1px #ddd solid;padding: 5px;margin: auto;margin-bottom: 20px;">
		<p id="count-down" style="font-family: 'Segoe UI Bold';font-size: 25px;text-align: center;">
...
<div class="big-panel-box" style="margin-top:20px;width: 49%;float: left;border:transparent;">
	<p style="font-family: 'Segoe UI Bold';margin-left:25px;margin-top: 0px;">Catatan Penting</p>
	<ul>
...
<table width="100%" style="margin-top: 20px;border-top:1px #ddd solid;float:left">
			...
			<tr>
				...
				<td valign="top" style="width: 150px;">
					...
					<p style="font-size: 13px;font-family: 'Segoe UI Bold';"><?php echo $bank['bank_name']?></p>
...
<div class="big-panel-box" style="margin-top:20px;">
	<div class="title" style="border-radius: 0px;background: #f5f5f5;color:#434343;border-bottom:1px #ddd solid;">Upload bukti Transfer</div>
...
<table width="100%" style="">
	<tr>
		...
		<td><input type="text" name="your_bank_name" class="form-input" value="<?php echo $show['your_bank_name']?>" required></td>
	</tr>
	...
	<tr>
		...
		<td><input type="text" name="your_rekening_number" class="form-input" value="<?php echo $show['your_rekening_number']?>" required></td>
	</tr>

	<tr>
		<td class="tr" style="width: 200px;">
			<p class="t1">Atas Nama</p>
		</td>
		<td><input type="text" name="your_atas_nama" class="form-input" value="<?php echo $show['your_atas_nama']?>" required></td>
	</tr>
	...
	<tr>
		...
		<?php if($show['status'] == 0){ ?>
			...
			<button class="btn-white" type="submit" style="cursor:pointer;padding: 5px;font-size: 15px;font-family: 'Segoe UI Regular';border-radius: 4px">Konfirmasi Transfer</button>
