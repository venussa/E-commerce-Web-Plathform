...
<table width="100%" style="">
	...
	<tr>
		...
		<td><textarea type="text" name="description" class="form-input" rows="4" style="max-width: 96.1%;min-width: 96%;font-size:14px;" required><?php echo $show['description']?></textarea></td>
	</tr>
