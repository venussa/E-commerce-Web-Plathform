<div style="width: 600px;border:1px #ddd solid;padding:10px;border-radius: 5px">
	...
	<h3 style="font-family: Arial">Pesanan sudah kami teruskan ke jasa pengiriman</h3>
	<p style="color:#666;font-family: Arial;font-size: 13px;">Pesanan anda dengan nomor invoice <?php echo $order['invoice_id'] ?> telah kami teruskan ke pihak jasa pengiriman.</p>
	...
	<table width="100%" style="background: #f5f5f5;padding: 10px;">
		...
		<tr>
			...
			<td valign="top"><p style="font-weight: 600">Nomor Resi</p>
				<p style="font-size: 14px;color:#666"><?php echo $this->post("no_resi") ?></p>
			</td>
		</tr>
		<tr>
	...
	<br>
	<br>
	<a target="_blank" href="<?php echo HomeUrl()."/clientarea/detail_pesanan"?>?id=<?php echo $order['sorting_id']?>" style="cursor:pointer;"><button style="background: #fe4c50;border:1px #fe4c50 solid;color:#fff;padding:10px;font-family: Arial;border-radius: 5px;cursor: pointer;">Cek Status Pesanan</button></a>
