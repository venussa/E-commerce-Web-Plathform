<div style="width: 600px;border:1px #ddd solid;padding:10px;border-radius: 5px">
	...
	<p style="color:#666;font-family: Arial;font-size: 13px;"><b><?php echo userinfo()->username?></b> mengajukan permintaan penarikan saldo dompet digital Pada <?php echo date("d M Y, H:i")?> WIB</p>

	<a target="_blank" href="<?php echo HomeUrl()?>/adminpanel/refund_status?id=<?php echo $tf_id?>" style="cursor:pointer;"><button style="background: #fe4c50;border:1px #fe4c50 solid;color:#fff;padding:10px;font-family: Arial;border-radius: 5px;cursor: pointer;">Segera Verifikasi</button></a>
