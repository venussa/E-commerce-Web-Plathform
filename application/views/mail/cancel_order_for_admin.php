<div style="width: 600px;border:1px #ddd solid;padding:10px;border-radius: 5px">
	...
	<p style="color:#666;font-family: Arial;font-size: 13px;"><b><?php echo ucwords(userinfo()->first_name." ".userinfo()->last_name)?></b> mengajukan pembatalan atas produk <b><?php echo $product['title']?></b> dengan nomor invoice <b><?php echo $order['invoice_id']?></b> pada <?php echo date("d M Y, H:i")?> WIB</p>
