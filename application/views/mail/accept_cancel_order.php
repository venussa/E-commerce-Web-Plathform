<div style="width: 600px;border:1px #ddd solid;padding:10px;border-radius: 5px">
	...
	<p style="color:#666;font-family: Arial;font-size: 13px;">Hi <b><?php echo ucwords($user['first_name']." ".$user['last_name'])?></b>. Pengajuan pembatalan <b><?php echo $order['invoice_id']?> "<?php echo $product['title']?>"</b> Berhasil. <?php echo $refund_msg?> Terimakasih.</p>
