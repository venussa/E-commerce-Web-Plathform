<div style="width: 600px;border:1px #ddd solid;padding:10px;border-radius: 5px">
	...
	<p style="color:#666;font-family: Arial;font-size: 13px;">Hi <b><?php echo ucwords($user['first_name']." ".$user['last_name'])?></b>. Pengajuan penarikan saldo dompet digital sebesar <b>Rp <?php echo number_format(($show['saldo'] - $show['saldo'] - $show['saldo']))?></b> dengan <b>ID transaksi : <?php echo $show['tf_id']?></b> telah kami proses. Dana di transfer ke rekening <b><?php echo $show['rekening_number']?></b> atas nama <b><?php echo $show['card_name']?></b></p>
