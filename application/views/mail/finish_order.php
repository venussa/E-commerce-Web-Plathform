<div style="width: 600px;border:1px #ddd solid;padding:10px;border-radius: 5px">
	...
	<p style="color:#666;font-family: Arial;font-size: 13px;">Pesanan <b>"<?php echo $product['title']?>"</b> Telah selesai, Terimaksih sudah percaya untuk berbelanja di <?php echo setting()->title?></p>
