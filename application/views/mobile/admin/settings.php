...
<form method="POST" action="<?php echo HomeUrl()?>/adminpanel/save_setting" enctype="multipart/form-data">
	<table width="100%">
		<tr>
			...
			<input type="text" name="title" class="form-input" required value="<?php echo $setting->title?>"></td>
		</tr>
		...
		<tr>
			...
			<input type="text" name="tagline" class="form-input" required value="<?php echo $setting->tagline?>"></td>
		</tr>
		...
		<tr>
			...
			<textarea type="text" name="description" class="form-input" required style="font-size:13px;"><?php echo $setting->description?></textarea></td>
		</tr>
		...
		<tr>
			...
			<input type="text" name="contact" class="form-input" required value="<?php echo $setting->contact?>"></td>
		</tr>
		...
		<tr>
			...
			<input type="text" name="email" class="form-input" required value="<?php echo $setting->email?>"></td>
		</tr>
		...
		<tr>
			...
			<input type="text" name="facebook" class="form-input" required value="<?php echo $setting->facebook?>"></td>
		</tr>
		...
		<tr>
			...
			<input type="text" name="twitter" class="form-input" required value="<?php echo $setting->twitter?>"></td>
		</tr>
		...
		<tr>
			...
			<input type="text" name="instagram" class="form-input" required value="<?php echo $setting->instagram?>"></td>
		</tr>
		...
		<tr>
			<td class="tr" style="width: 200px;" valign="top">
				...
				<div style="border:1px #ddd solid;background: #fff;width: 300px;height:200px;vertical-align: middle;text-align: center;">
		...
		<tr>
			...
			<input type="text" name="api" class="form-input" required value="<?php echo $setting->api?>"><br><br></td>
		</tr>
		...
		<tr>
			...
			<div style="background: #f5f5f5;border:1px #ddd solid;padding: 5px;margin-bottom: 10px;width: 93%">
				<p style="font-size: 14px;font-weight:600">SMTP Hostname</p>
				<input type="text" name="smtp_host" class="form-input" required value="<?php echo $setting->smtp_host?>">
				<p style="font-size: 14px;font-weight:600">SMTP Port</p>
				<input type="text" name="smtp_port" class="form-input" required value="<?php echo $setting->smtp_port?>">
				<p style="font-size: 14px;font-weight:600">SMTP Username</p>
				<input type="text" name="smtp_user" class="form-input" required value="<?php echo $setting->smtp_user?>">
				<p style="font-size: 14px;font-weight:600">SMTP Password</p>
		...
		<tr>
			...
			<td style="border-top:1px #ddd solid;">
				<p style="margin-top: 10px;"><button class="btn-white" type="submit" style="width: 150px;cursor: pointer;">Save Setting</button></p></td>
		</tr>
