...
<div class="list-chat-box" style="border: none;overflow-y: unset;height:auto;float: none;width: 95%;margin-top: 20px;">
	...
	<tr>
		<td valign="top">
			...
			<p style=";font-size: 13px;width: 70px;margin-right:10px;position: absolute;">
						...
						<p style="margin-left:80px;font-size:14px;margin-top:25px;"><a style="color:#09f;font-weight:600;" href=""><?php echo $product['title']?></a></p>
						<p style="margin-left:80px;color:orangered;margin-top:-10px;font-size: 13px;">Rp <?php echo number_format($show['price'])?><span style="color:#666;font-size:12px;margin-left:5px;">x <?php echo $show['total_order']?> Product ( <?php echo number_format($product['weight'])?> Gr )</span></p>
						
		

			<p style="font-weight:600;float:none;width: 100%;color:#434343">Alasan Komplain</p>	
			<p style="border:3px orangered solid;padding: 5px;width: 100%;float:none;border-radius: 4px;background: #f9f9f9;margin-top:-10px"><?php echo $show['note_complain']?></p>
		...
		<tr>
			<td valign="top">
				...
				<p style="font-weight:600;margin-top:-10px;color:#09f;cursor: pointer;" onclick="window.location='<?php echo HomeUrl()?>/adminpanel/lihatorder?id=<?php echo $this->get("id")?>';">#<?php echo $show['invoice_id']?></p>
				...
				<p style="color:#666;font-style: italic;">Komplain di tangani oleh <a style="font-weight:600;color:#09f" href="<?php echo HomeUrl()?>/adminpanel/users?q=<?php echo $user_handle['username']?>"><?php echo ucwords($user_handle['first_name']." ".$user_handle['last_name'])?></a></p>
...
<div class="list-chat-box" style="display: <?php echo $display?>;float: none;width: 98%;margin-bottom: 10px">
...
<div class="chat-box" style="height: <?php echo $height?>;float: none;width: 98%">
	<div class="header" style="display: none;">
		<img src="<?php echo sourceUrl()?>/img/mark.jpg">
		<p class="title"><span id="title-username">Mark Zuckerberg</span> <span id="chat-username" style=";font-size:13px;color:#f5f5f5;text-shadow: 2px 2px 3px rgba(14,6,4,0.52);margin-left:5px;">e</span></p>
	...
	<div class="input-chat" style="display: none;">
		...
		<form method="POST" id="form" chat_type="<?php echo $this->get("action")?>" onSubmit="return send_chat(this)">
			...
			<img src="<?php echo sourceUrl()?>/media/cam.png" width="35" style="margin-top:10px;cursor:pointer" onClick="click_upload('file-upload')">
...
<div id="preview-upload" class="upload-hover" style="left: 0px;display: none;background: #f5f5f5">
...
<p style="padding-top:10px;font-weight:600;width: 100%;float:none;border-top:1px #ddd solid;">Pilih solusi yang di sepakati</span></p>

<div style="border:1px #ddd solid;padding:5px;float:none;width: 95%;margin-top:10px;border-radius: 5px;background: #f6f6f6">
...
<table width="100%">
	<tr>
		...
		<td>
			...
			<p style="padding-top:10px;font-weight:600;">Catatan <span style="color:#666;font-size:11px;"> ( * Catatan hasil negosiasi dengan customer )</span></p>
...
<div style="border:1px #ddd solid;padding:5px;width: 95.5%;margin-top:10px;border-radius: 5px;background: #f6f6f6">
...
<div style="float:none;height: 20px;width: 100%"></div>