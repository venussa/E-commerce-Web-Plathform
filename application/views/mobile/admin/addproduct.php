...
<table width="100%" style="">
	<tr>
		...
		<input type="text" name="title" class="form-input" required></td>
	</tr>
	...
	<tr>
		...
		<input type="text" name="weight" class="form-input" required></td>
	</tr>
	...
	<tr>
		...
		<input type="text" name="stock" class="form-input" required></td>
	</tr>
	...
	<tr>
		...
		<input type="text" name="min_order" class="form-input" required  value="1"></td>
	</tr>
	...
	<tr>
		...
		<input type="text" name="price" class="form-input" required></td>
	</tr>
	...
	<tr>
		<td class="tr" style="width: 200px;">
			...
			<div  style="width: 97.5%;background: #f5f5f5;border:1px #ddd solid;padding: 5px;">
				<input type="text" name="discount" class="form-input" placeholder="Besar Potongan Harga">
				<br>
				<br>
				Dari : <input type="date" class="form-input"  name="start_time"><br><br>
				Sampai : <input type="date"  class="form-input" name="end_time">
			</div>
		</td>
	</tr>
