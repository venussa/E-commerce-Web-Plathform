...
<div class="big-panel-box" style="margin-top:20px;margin-right: 4%;width: 98%">
	<div class="list">
		...
		<p style="font-weight:600;color:#434343;">Main Category Image</p>
		...
		<table width="100%">
			...
			<tr>
				<td style="width: 150px;">
					<p style="font-weight:600;color:#434343;">Parent</p>
...
<div class="big-panel-box" style="margin-top:20px;width: 98%">
	...
	<div style="margin:auto;margin-top:-5px;margin-bottom:10px;width: 100%;">

	<div style="margin-top:18px;padding-left:10px;font-size: 10px;font-style: italic;color:#666;">
