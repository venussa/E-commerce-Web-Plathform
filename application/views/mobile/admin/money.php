...
<form method="get" action="<?php echo HomeUrl()?>/adminpanel/money" >
<input style="width: 97%;float: none;" class="tb-search" type="text" name="q" placeholder="Search ..." value="<?php echo urldecode($this->get("q"))?>">
</form>
<div class="big-panel-box" style="margin-top:20px;">
	...
	<div class="list">
		<table width="100%">
			...
			if($query->rowCount() == 0){?>
				...
				<tr><td colspan="4">
					...
					<div style="padding: 10px;text-align: center;height:283px;margin-top: 30px;">
						...
						<p style="font-weight:600;font-size: 18px;">Ringkasan Tidak Ditemukan</p>
			...
			<tr>
				<td valign="top">
					<p style="font-weight:600;"><a style="color:#09f;font-weight:600;" href="<?php echo HomeUrl()?>/adminpanel/product?q=<?php echo $show['product_id']?>"><?php echo $show['title']?></a></p>
					<p style="font-size:12px;"><span style='font-weight:600;'>Suplier : </span><?php echo ucwords($user['first_name']." ".$user['last_name']) ?> <span style="color:#666;font-size:12px;"> <a style="color:#09f;" href="<?php echo HomeUrl()?>/adminpanel/users?q=<?php echo $user['username']?>">(@<?php echo $user['username']?>)</a></span></p>
					<p style="font-size:12px;"><span style='font-weight:600;'>Product Id : <span>#<?php echo $show['product_id']?></p>
					
					<p style="font-size:12px;"><span style='font-weight:600;'>Stock : </span><?php echo $show['stock']?></p> 
					...
					<p style="font-size:12px;"><span style='font-weight:600;'>Order Tertunda : </span><?php echo $ordered?></p>
					<p style="font-size:12px;"><span style='font-weight:600;'>Order Terverifikasi : </span><?php echo $order_finish?></p>
					<p style="font-size:12px;"><span style='font-weight:600;'>Stok Tertunda : </span><?php echo $pending_stock?></p>
					<p style="font-size:12px;"><span style='font-weight:600;'>Stok Terkirim : </span><?php echo $send_stock?></p>
					<p style="font-size:12px;"><span style='font-weight:600;'>Stok Tersisa : </span><?php echo $stock?></p>
					
			

					<p style="font-size:15px;font-weight:600;color:orangered">Rp <?php echo $price?></p>
