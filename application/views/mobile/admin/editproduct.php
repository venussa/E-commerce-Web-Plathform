...
<table width="100%" style="">
	...
	<tr>
		...
		<textarea type="text" name="description" class="form-input" rows="4" style="width: 94%;font-size:13px;" required><?php echo $show['description']?></textarea></td>
	</tr>
	...
	<tr>
		<td class="tr" style="width: 200px;">
			...
			<div  style="width: 97.5%;background: #f5f5f5;border:1px #ddd solid;padding: 5px;">
				...
				<br>
				<br>
				Dari : <input type="date" value="<?php echo $start_time?>" class="form-input" name="start_time"><br><br>
				Sampai : <input type="date" value="<?php echo $end_time?>" class="form-input" name="end_time">
			</div>
		</td>
	</tr>
