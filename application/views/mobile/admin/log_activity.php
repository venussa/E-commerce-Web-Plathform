...
<input style="float: none;width: 97%;border-radius:5px;margin-top:10px;" class="tb-search" type="text" name="q" placeholder="Search ..." value="<?php echo urldecode($this->get("q"))?>">
</form>
			...
			if($query->rowCount() == 0){?>
				...
				<tr><td colspan="2">
					...
					<div style="padding: 10px;text-align: center;height:283px;margin-top: 30px;">
						...
						<p style="font-weight:600;font-size: 18px;">Tidak Ada Aktivitas</p>
