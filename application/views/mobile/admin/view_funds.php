...
<form method="get" action="<?php echo HomeUrl()?>/adminpanel/view_funds" >
	...
	<div class="list">
		<table width="100%">
			...
			while($show = $query->fetch()){ 
				...
				if($show['type'] == 0){
					$msg = "Pengembalian dana pembelian produk  <br><a style='color:orangered' href='".HomeUrl()."/adminpanel/orders?id=".$show['user_id']."&q=".$show['invoice_id']."'>".$show['invoice_id']."</a>";
					$color = "#3abd75";
					$symbol = "+";
