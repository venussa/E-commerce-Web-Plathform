...
<table width="100%" style="">
	<tr>
		...
		<input type="text" name="title" class="form-input" required  onKeyup="return create_slug(this)"value="<?php echo $show['title']?>"></td>
	</tr>
	...
	<tr>
		...
		<input type="text" name="slug" class="form-input" required id="slugs" value="<?php echo $show['slug']?>">
	...
	<tr>
		<td colspan="2">
			...
			<textarea type="text" name="content" class="form-input textarea" rows="15" style="width: 94%"><?php echo $show['content']?></textarea>
		</td>
	</tr>
