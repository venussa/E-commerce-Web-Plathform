...
box-shadow: 1px 3px 6px 1px rgba(0,0,0,0.2);padding: 10px;border-radius: 5px;">Keranjang Belanja</p>
	...
	<div class="list">
				...
				?>
					...
					<tr>
						...
						<td valign="top" style="width: 110px;border-bottom: 1px #ddd solid;">
							<p style="margin-top: 23px;"><img src="<?php echo sourceUrl()."/content/".$picture[0]?>" style="width: 90px;height:90px;border:1px #ddd solid;border-radius: 5px;"></p>
						</td>
						...
						<td valign="top" style="border-bottom: 1px #ddd solid;width: 300px;">
							...
							<p style="font-size:16px;margin-top:20px;">
								<a href="<?php echo $url?>" style=";color:#434343;font-size: 15px;font-weight: 600"><?php echo strip_tags($product['title'])?></a></p>
							<p style="color:orangered;font-size:13px;margin-top:-10px;"><?php echo $discount_price?>
								
								<span style="margin-left:10px;color:#666;font-size: 12px;;">1 barang ( <?php echo $product['weight']?> gr )</span>
							</p>
							...
							<p style="float:left;width: 150px;">
								...
								<button class="btn-white" type="submit" style="color:#fff;font-size:15px;width: 100px;border-radius: 5px;background: #fe4c50;border:1px #fe4c50 solid;">Lanjut Beli</button>
							</p>
			...
			<?php }else{ ?>
				<div style="padding: 10px;text-align: center;height:283px">
					...
					<p style=";">Tidak Ada Barang di Keranjang</p>
