...
box-shadow: 1px 3px 6px 1px rgba(0,0,0,0.2);padding: 10px;border-radius: 5px;">Tambah Alamat</p>
...
<table width="97%" style="">
	...
	<tr>
		...
		<input type="text" name="nama_penerima" class="form-input" required></td>
	</tr>
	...
	<tr>
		...
		<input type="text" name="address" class="form-input" required></td>
	</tr>
