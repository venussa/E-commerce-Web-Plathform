...
box-shadow: 1px 3px 6px 1px rgba(0,0,0,0.2);padding: 10px;border-radius: 5px;">Daftar Komplain</p>
<p style="padding-bottom:10px;font-size:14px"><i>Daftar komplain yang tengah diajukan, Mohon tunggu beberapa saat hingga staff kamu menghubungi anda.</i></p>

<div class="big-panel-box" style="margin-top:20px;float: none;width: 99%">
			...
			<tr>
				<td valign="top" colspan="2" style="border: transparent;">
					...
					<p style="font-size: 13px;width: 70px;margin-right:10px;position: absolute;">
						...
						<p style="font-size:14px;margin-top:20px;margin-left: 80px;"><a style="color:#434343;font-weight:600;" href="<?php echo HomeUrl()?>/clientarea/detail_pesanan?id=<?php echo $show['sorting_id']?>"><?php echo $product['title']?></a></p>
			...
			<tr>
				...
				<td valign="top" style="width: 120px;border-bottom: 1px #ccc solid;">
					...
					<p style="font-size: 13px;margin-top: 35px;">
						<a href="<?php echo HomeUrl()?>/clientarea/detail_komplein?id=<?php echo $show['sorting_id']?>"><button class="btn-white" style="width: 110px;border-radius: 5px;background: #fe4c50;border:1px #fe4c50 solid;">Selengkapnya</button></a>
					</p>
					<?php }else{ ?>

						<p style="color:orangered;font-style: italic;font-size: 11px;">Mohon Tunggu, Staff kami akan segera menghubungi anda</p>
