...
box-shadow: 1px 3px 6px 1px rgba(0,0,0,0.2);padding: 10px;border-radius: 5px;">Komplain Pembelian</p>
...
<div class="big-panel-box" style="margin-top:10px;padding: 5px;width: 96%;background: #f5f5f5;border-radius: 5px;">
	...
	<p style="font-weight:600;">Alasan Melakukan Komplain</p>
	...
	<p align="right">
		...
		<button class="btn-white" type="submit" style="border-radius: 4px;background: #fe4c50;border:1px #fe4c50 solid;width: 100%">Ajukan Komplain</button></p>
	</form>
</div>
	...
	<tr>
		...
		<td valign="top" >
			...
			<p style="font-size: 13px;width: 70px;margin-right:10px;position: absolute;">
						...
						<p style="font-size:14px;margin-top:25px;margin-left: 80px;"><a style="color:#434343;font-weight:600;" href="<?php echo HomeUrl()?>/product/<?php echo url_title($product['title'],"-",true)?>?id=<?php echo $product['sorting_id']?>"><?php echo $product['title']?></a></p>
					...
					<p style="width: 93%;border:1px #ddd solid;border-radius: 5px;background: #f5f5f5;padding: 10px;">
