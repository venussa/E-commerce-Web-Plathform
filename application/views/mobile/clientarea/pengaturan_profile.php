...
box-shadow: 1px 3px 6px 1px rgba(0,0,0,0.2);padding: 10px;border-radius: 5px;">Rubah Data Pribadi</p>
...
<form method="POST" action="<?php echo HomeUrl()?>/clientarea/change_profile" enctype="multipart/form-data">
		...
		<div>
			<p class="input-title" style="font-weight:600">Nama Depan</p>
			...
			<p class="input-title" style="font-weight:600">Nama Belakang</p>
			...
			<p class="input-title" style="font-weight:600">Jenis Kelamin</p>
			...
			<p class="input-title" style="font-weight:600">Email</p>
			...
			<p class="input-title" style="font-weight:600">Username</p>
			...
			<p class="input-title" style="font-weight:600">Nomor Telephone</p>
			...
			<p class="input-title" style="font-weight:600">Alamat Lengkap</p>
			...
			<p class="input-title" style="font-weight:600" style="margin-top: 5px;">Provinsi</p>
			...
			<p class="input-title" style="font-weight:600">Kabupaten / Kota</p>
			...
			<p class="input-title" style="font-weight:600">Kecamatan</p>
			...
			<p class="input-title" style="font-weight:600">Kode Pos</p>
			...
			<p class="input-title" style="font-weight:600">Foto Profile</p>
		...
		<div style="font-size:14px;margin-top:10px;background: #f5f5f5;padding: 10px;border:1px #ddd solid;border-radius: 5px;">
			...
			<button id="submit-profile-data" class="btn-white" type="submit" style="cursor:pointer;padding: 10px;font-size: 15px;padding:6px;border-radius: 4px;background: #fe4c50;border:1px #fe4c50 solid">Save Changes</button>
			</div>
		</div>
		...
		<div id="modal-email" style="width: 100%;background: rgba(0, 0, 0, 0.5);position: fixed;z-index: 999;left: 0px;top:0px;height: 2000px;display: none;">
			...
			<div style="background: #fff;border:1px #ddd solid;padding: 15px;margin-top: 20px;border-radius: 5px;">
				...
				<span id="change-email">
					<p class="input-title" style="font-weight:600">Email Baru</p>
					...
					<p class="input-title" style="font-weight:600">Ulangi Email Baru</p>
					...
					<p class="input-title" style="font-weight:600">Kode Verifikasi </p>
					<input type="text" class="form-input" name="verifikasi" autocomplete="off" placeholder="" style="padding: 5px;font-size:13px;width: 68%;margin-right: 12px;" onKeyup="return verif(this)">
					<span style="color:#fff;background: #fe4c50;border:1px #fe4c50 solid;border-radius: 3px;padding: 5px;font-size:12px;cursor:pointer" onClick="return send_code(this)">Kirim Kode</span>
					
					

					<div style="width: 100%;margin-top:20px;border-top:2px #ddd dashed;padding-top: 10px;">
						<button class="btn-white" type="button" style="cursor:pointer;padding: 5px;border-radius:5px;font-size: 15px;background: #fe4c50;border:1px #fe4c50 solid" onClick="check_data()">Save Changes</button>
					</div>
	...
	<div id="modal-password" style="width: 100%;background: rgba(0, 0, 0, 0.5);position: fixed;z-index: 999;left: 0px;top:0px;height: 2000px;display: none;">
		...
		<div style="background: #fff;border:1px #ddd solid;padding: 15px;margin-top: 20px;border-radius: 5px;">
			...
			<span id="change-password">
				...
				<p class="input-title" style="font-weight:600">Password Lama</p>
				...
				<p class="input-title" style="font-weight:600">Password Baru</p>
				...
				<p class="input-title" style="font-weight:600">Ulangi Password</p>
