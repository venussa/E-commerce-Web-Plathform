...
<body>
	...
	<form method="POST" action="<?php echo HomeUrl()?>/login/auth_register?type=1">
			...
			<span style="float: right;border:1px #fe4c50 solid;color:#fff;background: #fe4c50;border-radius: 3px;padding: 5px;font-size:12px;margin-right: 10px;cursor:pointer" onClick="return send_code(this)">Kirim Kode</span>
		...
		<div>
			...
			<div style="border-top:1px #ddd dashed;margin-top:10px;padding-top:10px;">
				...
				<img src="<?php echo create_captcha()->captcha_image_url?>" style="width: 100%;border-radius: 5px;height: 70px;">
		...
		<input type="text" class="form-input" name="chaptcha" autocomplete="off" placeholder="Masukkan Chaptcha ">
			...
			<button class="btn-green" type="submit" style="cursor:pointer;width: 100%;margin: auto;">Kirim</button>
			</div>
		</div>
